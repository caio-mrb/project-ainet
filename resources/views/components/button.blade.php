...
@php
    $colors = match($type) {
        'rounded-primary' => 'text-white dark:text-gray-900 rounded-full
                        bg-primary-red  dark:bg-blue-400
        ...
        'secondary' => 'text-white dark:text-gray-700 rounded-md
        ...
        'success' => 'text-white dark:text-gray-900 rounded-md
        ...
        'danger' => 'text-white dark:text-gray-900 rounded-md
        ...
        'warning' => 'text-gray-900 dark:text-gray-200 rounded-md
        ...
        'info' => 'text-gray-900 dark:text-gray-200 rounded-md
        ...
        'light' => 'text-gray-900 dark:text-gray-200 rounded-md
                        bg-slate-50 dark:bg-slate-600
                        hover:bg-slate-200 dark:hover:bg-slate-700
                        focus:bg-slate-200 dark:focus:bg-slate-700
                        active:bg-slate-200 dark:active:bg-slate-700',
        'link' => 'text-blue-500 rounded-md
                        border-gray-200',
        default => 'text-white dark:text-gray-900 rounded-md
    ...
    @if ($element == 'a')
        <a href="{{ $href }}"
            class="px-4 py-2 inline-block border border-transparent
                    ...
                    focus:ring-secondary-gray dark:focus:ring-indigo-400
